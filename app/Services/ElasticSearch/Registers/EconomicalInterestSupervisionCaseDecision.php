...
class EconomicalInterestSupervisionCaseDecision extends AbstractRegister implements RegisterInterface
{

    public const URL = 'economical_interest_supervision_case_decision';
