...
class UnsafeAndNonCompliantGoods extends AbstractRegister implements RegisterInterface
{

    public const URL = 'unsafe_and_non_compliant_goods';
    public const API_URL = 'unsafe-and-non-compliant-goods';
    ...
    public function getParams(): array
    {
        ...
        if (!empty($_GET['q'])) {
            $fullBody['body']['query']['bool']['filter'][] = [
                'multi_match' => [
                    'query' => $_GET['q'],
                    'fields' => ['ptacItemName^2', 'ptacItemModel'],
                ]
            ];
        }
