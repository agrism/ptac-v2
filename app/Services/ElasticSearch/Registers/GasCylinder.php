...
class GasCylinder extends AbstractRegister implements RegisterInterface
{

    public const URL = 'gas_cylinder';
    public const API_URL = 'gas-cylinder';
    ...
    public function getParams(): array
    {
        ...
        if (!empty($_GET['q'])) {
            $fullBody['body']['query']['bool']['filter'][] = [
                'multi_match' => [
                    'query' => $_GET['q'],
                    'fields' => [
                        'ptacCaseTargetedPersonName',
                        'stationarySellingPlaceName',
                        'stationarySellingPlaceAddressName',
                    ],
                ]
            ];
        }
        ...
        if (!empty($_GET['registration_number'])) {
            $fullBody['body']['query']['bool']['filter'][] = [
                'term' => [
                    'ptacCaseTargetedPersonRegNrOrPersonalCode' => $_GET['registration_number'],
                ]
            ];
        }
