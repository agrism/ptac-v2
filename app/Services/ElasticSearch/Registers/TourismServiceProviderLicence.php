...
class TourismServiceProviderLicence extends AbstractRegister implements RegisterInterface
{

    public const URL = 'tourism_service_provider_licence';
    public const API_URL = 'tourism-service-provider-licence';
    ...
    public function getParams(): array
    {
        ...
        if (!empty($_GET['q'])) {
            $fullBody['body']['query']['bool']['filter'][] = [
                'multi_match' => [
                    'query' => $_GET['q'],
                    'fields' => ['ptacCaseTargetedPersonName^2', 'ptacCaseTargetedPersonAddressDisplayName'],
                ]
            ];
        }
